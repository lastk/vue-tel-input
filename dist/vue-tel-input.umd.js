(function (global, factory) {
	...
	_export$1(_export$1.S + _export$1.F * (_library ), PROMISE, {
	...
	// 19.2.4.2 name
	NAME$2 in FProto || _descriptors && dP$2(FProto, NAME$2, {
	  configurable: true,
	  get: function () {
	    try {
	...
	*/
	...
	function getDefault(key) {
	  var value = utils$1.options[key];

	  if (typeof value === 'undefined') {
	    return utils$1.options[key];
	  }
	    ...
	    initializeCountry: function initializeCountry() {
	      ...
	      return new Promise(function (resolve) {
	        ...
	        if (!_this4.disabledFetchingCountry) {
	          _this4.fetchCountry().then(function (res) {
	...
	function install(Vue) {
	  ...
	  utils$1.options = _objectSpread$2({}, defaultOptions, {}, customOptions);
